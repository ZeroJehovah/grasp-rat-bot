...
function rememberOpportunityChoiceCore(item, action, previous = null, options = {}) {
  ...
  const choice = {
    ...
    heldCandidateSource: String(item.heldCandidateSource || ''),
    heldRewardSource: String(item.heldRewardSource || ''),
    heldRewardKnown: item.heldRewardKnown === undefined ? null : Boolean(item.heldRewardKnown),
    heldRewardObservedAt: Number.isFinite(Number(item.heldRewardObservedAt)) ? Number(item.heldRewardObservedAt) : null,
    heldProvenanceExpiresAt: Number.isFinite(Number(item.heldProvenanceExpiresAt)) ? Number(item.heldProvenanceExpiresAt) : null,
    targetHp: Number.isFinite(Number(item.targetHp ?? item.sourceTarget?.hp)) ? Number(item.targetHp ?? item.sourceTarget?.hp) : null,
    targetActive: item.targetActive === undefined && item.sourceTarget?.active === undefined
      ? null
      : Boolean(item.targetActive ?? item.sourceTarget?.active),
  ...
  return {
    ...
    action: {
      ...
      opportunityChoice: {
        ...
        heldCandidateSource: choice.heldCandidateSource,
        heldRewardSource: choice.heldRewardSource,
        heldRewardKnown: choice.heldRewardKnown,
        heldRewardObservedAt: choice.heldRewardObservedAt,
        heldProvenanceExpiresAt: choice.heldProvenanceExpiresAt,
