...
function createEntityStateRuntime(runtime = {}) {
  ...
  return {
    ...
    isStaminaWindowExhausted,
    combatMovementBlockedByStamina,
    hasLongWindowStamina,
    hasMoveStamina,
    hasAttackStamina,
    staminaLimit,
    hasFullStamina,
    ...
    entityRecentActivityAgeMs,
    recentlyActionedForAfk,
    isIdleInvulnerableTarget,
    isAvoidanceThreat,
    isAfkTarget,
    isAfkProfitTarget,
    hpValue,
