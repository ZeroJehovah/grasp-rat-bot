...
${combatStateSource()}${combatFireSource()}  function combatLeaveCoverAction(self, target, bullets, targetDistance = null) {
...
${combatActionSource()}	  function snapshotCoinAgeMs() {
