...
function buildRuntimeDefaults(config, combatLogEndpointConfigured) {
  return {
    ...
    tickMs: 120,
    combatControlIntervalMs: numberDefault(config.combatControlIntervalMs, 160),
    ...
    combatClosePressureMinRangeCm: numberDefault(config.combatClosePressureMinRangeCm, 2000),
    combatClosePressureMaxRangeCm: numberDefault(config.combatClosePressureMaxRangeCm, 3000),
