...
function buildRuntimeDefaults(config, combatLogEndpointConfigured) {
  return {
    ...
    combatMissCloseTriggerShots: numberDefault(config.combatMissCloseTriggerShots, 10),
    combatMissCloseStepShots: numberDefault(config.combatMissCloseStepShots, 10),
    combatMissCloseStepCm: numberDefault(config.combatMissCloseStepCm, 1000),
    combatMissCloseMinimumDistanceCm: numberDefault(config.combatMissCloseMinimumDistanceCm, 1000),
    combatMissCloseTimeoutMs: numberDefault(config.combatMissCloseTimeoutMs, 30000),
    combatMissCloseGenerationMaxMs: numberDefault(config.combatMissCloseGenerationMaxMs, 90000),
    combatMissCloseGenerationMaxSteps: numberDefault(config.combatMissCloseGenerationMaxSteps, 4),
