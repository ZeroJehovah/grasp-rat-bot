...
function buildRuntimeDefaults(config, combatLogEndpointConfigured) {
  ...
  return {
    ...
    incomingPressureEvidenceLeaseMs,
    combatResidualDodgeContinuationMs: numberDefault(config.combatResidualDodgeContinuationMs, 650),
    combatRewardFinishBackAwayHoldEnabled: config.combatRewardFinishBackAwayHoldEnabled !== false,
    combatRewardFinishHoldMinSelfHp: numberDefault(config.combatRewardFinishHoldMinSelfHp, 50),
    ...
    loginPointReloginShortcutEnabled: config.loginPointReloginShortcutEnabled !== false,
    loginPointReloginShortcutMinCurrentDistanceCm: numberDefault(config.loginPointReloginShortcutMinCurrentDistanceCm, 40000),
    loginPointReloginShortcutMinGainCm: numberDefault(config.loginPointReloginShortcutMinGainCm, 30000),
    loginPointReloginShortcutMaxLoginDistanceRatio: numberDefault(config.loginPointReloginShortcutMaxLoginDistanceRatio, 0.75),
    loginPointReloginShortcutMinNetGainMs: numberDefault(config.loginPointReloginShortcutMinNetGainMs, 30000),
    loginPointReloginShortcutPlanSpeedCmPerS: numberDefault(config.loginPointReloginShortcutPlanSpeedCmPerS, 950),
    loginPointReloginShortcutBaseOverheadMs: numberDefault(config.loginPointReloginShortcutBaseOverheadMs, 12000),
    loginPointReloginShortcutSnapshotEdgeOverheadMs: numberDefault(config.loginPointReloginShortcutSnapshotEdgeOverheadMs, 65000),
    loginPointReloginShortcutSourceIpProbeOverheadMs: numberDefault(config.loginPointReloginShortcutSourceIpProbeOverheadMs, 50000),
    loginPointReloginShortcutFreshMaxMs: numberDefault(config.loginPointReloginShortcutFreshMaxMs, 120000),
    loginPointReloginShortcutMaxPointDriftCm: numberDefault(config.loginPointReloginShortcutMaxPointDriftCm, 5000),
    loginPointReloginShortcutTargetMinDrop: numberDefault(config.loginPointReloginShortcutTargetMinDrop, 50),
    loginPointReloginShortcutTargetMaxDriftCm: numberDefault(config.loginPointReloginShortcutTargetMaxDriftCm, 2000),
    loginPointReloginShortcutMaxPerSession: numberDefault(config.loginPointReloginShortcutMaxPerSession, 1),
    loginPointReloginShortcutMaxPerDay: numberDefault(config.loginPointReloginShortcutMaxPerDay, 6),
    loginPointReloginShortcutCooldownMs: numberDefault(config.loginPointReloginShortcutCooldownMs, 300000),
    autoLogin: true,
