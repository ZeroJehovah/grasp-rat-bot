...
function createInitialDecisionState(options = {}) {
  ...
  return {
    ...
    combatMovementStability: cloneJson(options.combatMovementStability || null),
    ...
    nonThreatCombatEconomicsByTarget: asRecord(options.nonThreatCombatEconomicsByTarget),
...
function summarizeBrowserlessDecisionState(state, options = {}) {
  ...
  return {
    ...
    combat: {
      ...
      movementStability: redactBoundedValue(state.combatMovementStability || null),
    ...
    browserlessSafety: {
      ...
      recoveryContactGuard: redactBoundedValue(state.recoveryContactGuard || null),
      profitPursuitSuppressions: recordEntries(state.profitPursuitSuppressions || {}, limit),
      nonThreatCombatEconomics: recordEntries(state.nonThreatCombatEconomicsByTarget || {}, limit),
