...
- Recent important coverage:
  ...
  - high-value visible coins override active combat, recovery wait, incoming-bullet pressure, close non-invulnerable combat, and invulnerable avoidance when HP is healthy, while low-HP pickups still require no incoming bullet/current combat/nearby non-invulnerable real threat;
