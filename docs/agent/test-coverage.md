...
- Recent important coverage:
  ...
  - target-owned real-bullet pressure fire has bot self-test coverage for the mid-HP pressure window, and sustained pressure no-damage stop-loss has bot self-test coverage for exiting a losing target-owned pressure trade after 10s without target damage at the earlier 80HP gate. Replay coverage for 2026-06-21 pressure samples shows 07:56 biliee improving from logged `3/56` to `11/72`, 09:21 biliee from `5/112` to `38/192`, ahy6a from `9/76` to `13/90`, and the 10:15 biliee stop-loss sample exiting about 13s before the logged end at `67/79` after `11596ms` no-damage. The 2026-06-22 biliee stop-loss replay exits at line `436` (`79/91`, `12319ms` no damage), about `18528ms` before the logged end.
