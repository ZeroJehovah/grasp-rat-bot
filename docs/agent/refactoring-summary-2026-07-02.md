...
126. Combat/profit/safety helpers: integrate only in small, replay-validated slices
127. Run live validation sessions after each behavior-touching replacement
