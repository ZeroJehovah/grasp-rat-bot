...
136. Combat/profit/safety helpers: integrate only in small, replay-validated slices
137. Run live validation sessions after each behavior-touching replacement
